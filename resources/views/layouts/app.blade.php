...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="{{asset('assets/imgs/theme/Dido_Grrrrr.ico')}}">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-6 col-lg-4">
                            <div class="text-center">
                                <div id="news-flash" class="d-inline-block">
                                    <ul>
                                        <li>Obtenez jusqu'à 50 % de réduction<a href="{{route('produit')}}">Voir les détails</a></li>
                                        <li>Offres - Économisez plus avec des coupons</li>
                                        <li>Economisez jusqu'à 35% aujourd'hui <a href="{{route('produit')}}">Boutique</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-4">
                            <div class="header-info header-info-right">
                                    ...
                                    <ul>                               
                                        <li><i class="fi-rs-user"></i>{{Auth::user()->name}}  / 
                                            <form method="POST" action="{{route('auth.deconnexion')}}"> 
                                                @method('delete')
                                                @csrf
                                                <a href="{{route('auth.deconnexion')}}" onclick="event.preventDefault(); this.closest('form').submit();">Deconnexion</a>
                                            </form>
                                        </li>
                                    </ul>
                                @else
                                ...
                                <ul>                                
                                    <li><i class="fi-rs-key"></i><a href="{{route('auth.connexion')}}">Se connecter </a>  / <a href="{{route('auth.inscription')}}">S'inscrire</a></li>
                                </ul>
                                @endif
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="header-wrap">
                        <div class="logo logo-width-1">
                            <a href="/"><img src="{{asset('/assets/imgs/logo/Dido_Grrrrr.png')}}" alt="logo"></a>
                        </div>
                        ...
                        <div class="header-nav d-none d-lg-flex">
                            <div class="main-categori-wrap d-none d-lg-block">
                                <a class="categori-button-active" href="#">
                                    <span class="fi-rs-apps"></span> Les Catégories
                                </a>
                                    ...
                                    <ul>
                                        ...
                                        @auth
                                            <li><a href="#">Mon compte<i class="fi-rs-angle-down"></i></a>
                                                @if (Auth::user()->utype === 'ADM' && Auth::user()->etat === 'autorise')
                                                    <ul class="sub-menu">
                                                        <li><a href="{{route('admin.dashboard')}}">Dashboard</a></li>
                                                        <li><a href="{{route('fournisseur.produit')}}">Mes productuits</a></li>
                                                        <li><a href="#">Les commandes</a></li>                                             
                                                    </ul>
                                                @elseif (Auth::user()->utype == 'SADM')
                                                    <ul class="sub-menu">
                                                        <li><a href="{{route('super.dashboard')}}">Dashboard</a></li>
                                                        <li><a href="{{route('admin.listvendeurs')}}">Les fournisseurs</a></li>
                                                        <li><a href="{{route('admin.client')}}">les clients</a></li>
                                                        <li><a href="{{route('admin.categories')}}">Categories</a></li>
                                                        <li><a href="{{route('admin.produit')}}">Les produits</a></li>
                                                        <li><a href="#">Les commandes</a></li>
                                                    </ul>
                                                @else    
                                                    <ul class="sub-menu">
                                        ...
                                        @endif
                                        <li><a href="{{route('vendeurs')}}">Vendeurs</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        <div class="hotline d-none d-lg-block">
                            <p><i class="fi-rs-smartphone"></i>(+1) 0000-000-000 </p>
                        </div>
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                        ...
                                        <div class="shopping-cart-footer">
                                            ...
                                            <div class="shopping-cart-button">
                                                ...
                                                <a href="shop-checkout.php">Vérifier</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="mobile-header-content-area">
                    ...
                    <div class="mobile-menu-wrap mobile-header-border">
                        ...
                        <nav>
                            <ul class="mobile-menu">
                                ...
                                <li class="menu-item-has-children"><span class="menu-expand"></span><a href="shop.html">Boutique</a></li>
                    ...
                    <div class="mobile-header-info-wrap mobile-header-border">
                        <div class="single-mobile-header-info mt-30">
                            <a href="contact.html"> Notre emplacement </a>
                        </div>
                        ...
                        <div class="col-lg-7 mb-md-3 mb-lg-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col my-4 my-md-0 des">
                                    <h5 class="font-size-15 ml-4 mb-0">...et recevez <strong>$25 de coupon pour le premier achat.</strong></h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-5">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="widget-about font-md mb-md-5 mb-lg-0">
                                ...
                                <p class="wow fadeIn animated">
                                    <strong>Address: </strong>Abidjan (Côte d'Ivoire)
                                </p>
                                <p class="wow fadeIn animated">
                                ...
                                <h5 class="mb-10 mt-30 fw-600 text-grey-4 wow fadeIn animated">Suivez nous</h5>
                        ...
                        <div class="col-lg-2 col-md-3">
                            ...
                            <ul class="footer-list wow fadeIn animated mb-sm-5 mb-md-0">
                                ...
                                <li><a href="#">Conditions &amp; Confidentialité</a></li>
                        ...
                        <div class="col-lg-4 mob-center">
                            <h5 class="widget-title wow fadeIn animated">Installer l'application</h5>
                            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <p class="float-md-left font-sm text-muted mb-0">
                            <a href="privacy-policy.html">Politique de confidentialité</a> | <a href="terms-conditions.html">Conditions &amp; Confidentialité</a>
                        </p>
                    </div>
                    <div class="col-lg-6">
                        <p class="text-lg-end text-start font-sm text-muted mb-0">
                            &copy; <strong class="text-brand">Firewall Agency</strong> Tous les droits sont réservés
                        </p>
                    </div>
                </div>
            </div>
