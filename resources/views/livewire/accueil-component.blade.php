                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                        <div class="banner-features wow fadeIn animated hover-up">
                            ...
                            <h4 class="bg-2">Faites des éconnomies</h4>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                        <div class="banner-features wow fadeIn animated hover-up">
                    ...
                    <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                        <div class="banner-features wow fadeIn animated hover-up">
                            ...
                            <h4 class="bg-5">Vente hereuse</h4>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                        <div class="banner-features wow fadeIn animated hover-up">
            ...
            <div class="container">
                <div class="tab-header">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="nav-tab-two" data-bs-toggle="tab" data-bs-target="#tab-two" type="button" role="tab" aria-controls="tab-two" aria-selected="false">Populaire</button>
                        </li>
                        <li class="nav-item" role="presentation">
                                    ...
                                    <div class="product-cart-wrap mb-30">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="{{route('produit.detail', ['slug' => $produit->slug])}}">
                                                    <img class="default-img" src="/uploads/{{$produit->image}}" alt="">
                                                    <img class="hover-img" src="/uploads/{{$produit->image}}" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="product-content-wrap">
                                            <div class="product-category">
                                                <a href="shop.html">{{$produit->marque->name}}</a>
                                            </div>
                                            <h2><a href="product-details.html">{{$produit->name}}</a></h2>
                                            ...
                                            <div class="product-price">
                                                <span>{{$produit->prix}} FrCFA</span>
                                                <span class="old-price">{{$produit->nprix}}</span>
                                            </div>
                                            <div class="product-action-1 show">
                                                <a aria-label="+ parnier" class="action-btn hover-up" href="cart.html"><i class="fi-rs-shopping-bag-add"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
