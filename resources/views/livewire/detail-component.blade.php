        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> {{$produit->marque->name}}
                    <span></span> {{$produit->name}}
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="product-detail accordion-detail">
                                    ...
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            <figure class="border-radius-10">
                                                <img src="/uploads/{{$produit->image}}" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="/uploads/{{$produit->image}}" alt="product image">
                                            </figure>
                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="product-detail-rating">
                                            <div class="pro-details-brand">
                                                <span> Marque: <a href="shop.html">{{$produit->marque->name}}</a></span>
                                            </div>
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                <ins><span class="text-brand">{{$produit->prix}} FrcFA</span></ins>
                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            <div class="product-extra-link2">
                                                <button type="submit" class="button button-add-to-cart">Ajouter au panier</button>
                                                <a aria-label="Add To Wishlist" class="action-btn hover-up" href="wishlist.php"><i class="fi-rs-heart"></i></a>
                                                <a aria-label="Compare" class="action-btn hover-up" href="compare.php"><i class="fi-rs-shuffle"></i></a>
                                            </div>
                                        </div>
                                        <ul class="product-meta font-xs color-grey mt-50">
                                            <li class="mb-5">SKU: <a href="#">{{$produit->sku}}</a></li>
                                            <li class="mb-5">Marque: <a href="#" rel="tag">Cloth</a>, <a href="#" rel="tag">Women</a>, <a href="#" rel="tag">Dress</a> </li>
                                            <li>Disponibilité:<span class="in-stock text-success ml-5">{{$produit->quantite}}, {{$produit->stock_etat}}</span></li>
                                        </ul>
                                    </div>
                                    <!-- Detail Info -->
                                </div>
                            ...
                            <div class="row mt-60">
                                <div class="col-12">
                                    <h3 class="section-title style-1 mb-30">Produits connexes</h3>
                                </div>
                                <div class="col-12">
                                    <div class="row related-products">
                                        @foreach ($rproduits as $rproduit)
                                            
                                       <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="{{route('produit.detail', ['slug' => $rproduit->slug])}}" tabindex="0">
                                                            <img class="default-img" src="/uploads/{{$produit->image}}" alt="{{$rproduit->name}}">
                                                            <img class="hover-img" src="/uploads/{{$produit->image}}" alt="{{$rproduit->name}}">
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="{{route('produit.detail', ['slug' => $rproduit->slug])}}" tabindex="0">{{$rproduit->name}}</a></h2>
                                                    <div class="rating-result" title="90%">
                                                        <span>
                                                        </span>
                                                    </div>
                                                    <div class="product-price">
                                                        <span>{{$rproduit->prix}} FrcFA</span>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        <div class="widget-category mb-30">
                            ...
                            <ul class="categories">
                                @foreach ($categories as $categorie)
                                    <li><a href="shop.html">{{$categorie->name}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        <!-- Fillter By Price -->
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            @foreach ($nproduits as $nproduit)
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="/uploads/{{$produit->image}}" alt="#">
                                </div>
                                <div class="content pt-10">
                                    <h5><a href="{{route('produit.detail', ['slug'=>$nproduit->slug])}}">{{$nproduit->name}}</a></h5>
                                    <p class="price mb-0 mt-5">{{$nproduit->prix}} FrcFA</p>
