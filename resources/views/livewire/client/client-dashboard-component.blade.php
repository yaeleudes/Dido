                                    ...
                                    <div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5 class="mb-0">Hello {{$client->name}}! </h5>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="card mb-3 mb-lg-0">
                                                    ...
                                                    <div class="card-body">
                                                        <address>
                                                            <h3 class="fw-bold fs-3 mb-2">{{$client->ville}}</h3> 
                                                            <span class="">{{$client->commune}}</span><br> 
                                                            <hr>
                                                            Sault Ste. <br>
                                                            Marie, MI 00000
                                                        </address>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="card" id="modif_adresse" style="visibility: hidden">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <form wire:submit.prevent="updateAdresse">
                                                            {{-- @method('patch') --}}
                                                            @csrf
                                                            <div class="d-flex flex-column">
                                                                <div class="form-group col-md-12">
                                                                    <label for="ville">Ville <span class="required">*</span></label>
                                                                    <input  class="form-control square" name="ville" type="text" wire:model="ville">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="commune">Commune <span class="required">*</span></label>
                                                                    <input  class="form-control square" name="commune" type="text" wire:model="commune">
                                                                </div>
                                                            </div>
                                                            <div class="row justify-content-center">
                                    ...
                                    <div class="tab-pane fade" id="account-detail" role="tabpanel" aria-labelledby="account-detail-tab">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                {{-- <form method="post" name="enq" action="{{route('auth.update')}}"> --}}
                                                <form wire:submit.prevent="updateDetail">
                                                    @method('patch')
                                                    @csrf
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            <label for="name">Nom <span class="required">*</span></label>
                                                            <input  class="form-control square" name="name" type="text" wire:model="name">
                                                            @error('name')
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input  class="form-control square" name="nickname" wire:model="nickname">
                                                            @error('nickname')
                                                                <div class="alert alert-danger">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input  class="form-control square" name="telephone" type="text" wire:model="telephone">
                                                            @error('telephone')
                                                                <div class="alert alert-danger">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input  class="form-control square" name="email" type="email" wire:model="email">
                                                            @error('email')
                                                                <div class="alert alert-danger">{{ $message }}</div>
                                                            @enderror
                                                        </div>
