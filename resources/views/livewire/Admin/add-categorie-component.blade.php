        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span>   Ajouter une nouvelle catégorie
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <form wire:submit.prevent="storeCategorie">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" name="detail" id="" class="form-control" placeholder="Entrez un detail de la categorie" wire:model="detail" wire:keyup="slug">
                                @error('detail')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
